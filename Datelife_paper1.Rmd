...
<!--General issues with dating techniques:--> choosing correct fossils for calibration r
equires a lot of expertise and knowledge on the group. An incorrect use of fossils
...
It contains an improved databse of chronograms, more methods to summarize trees,
...
```{r, echo = FALSE}
fig_workflow_main_foot <- "Figure 1. Summarized DateLife workflow. Only main actions are shown."
```
...
to absolute time using information on ages obtained from published chronograms,--> by l
inking several external services and tested algorithms.
It takes advantage of the rotl, ape, and geiger packages to gather, process, and
present information.
...
```{r pressure, out.width="100%", include=FALSE, fig.align="center", fig.cap=fig_workflow_main_foot, echo=FALSE}
